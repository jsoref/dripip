...
OPTIONS
  ...
  --trunk=trunk              State which branch is trunk. Defaults to honouring the "base" branch setting in the GitHub
                             repo settings.
```
...
OPTIONS
  ...
  --trunk=trunk  State which branch is trunk. Defaults to honouring the "base" branch setting in the GitHub repo
                 settings.
```
<!-- commandsstop -->
